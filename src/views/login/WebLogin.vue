    ...
    <div class="login-plane">
      <div class="login-plane-container">
        ...
        <div class="login-plane-form">
          <el-form ref="formRef" :model="formField" :rules="formRules" size="larg">
            <el-form-item prop="user">
              <el-input v-model="formField.user" placeholder="用户名 / 账号" type="text" />
            </el-form-item>
            <el-form-item prop="pass">
              <el-input v-model="formField.pass" placeholder="密码" type="password" />
            </el-form-item>
            <div class="login-code-container">
              <el-form-item style="width: 50%" prop="code">
                <el-input v-model="formField.code" placeholder="验证码" type="text" />
              </el-form-item>
...
<script lang="ts">
  ...
  export default defineComponent({
    setup() {
      ...
      // 声明性能监控
      let stats: any = new (Stats as  any)()
      // 声明渲染器
      let renderer: any
      // 声明调试工具
      let gui = new GUI()
      ...
      // 初始化gui
      const initGUI = () => {
        const params = new (Params as any)
